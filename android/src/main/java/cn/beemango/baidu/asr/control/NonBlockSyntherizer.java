package cn.beemango.baidu.asr.control;
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case INIT:
                        ...
                        if (isSuccess) {
                            // speak("初始化成功");
                            sendToUiThread(MainHandlerConstant.INIT_SUCCESS, "NonBlockSyntherizer 初始化成功");
                        } else {
                            sendToUiThread(MainHandlerConstant.STATUS_ERROR, "合成引擎初始化失败, 请查看日志");
                        }
                        break;
                    case RELEASE:
